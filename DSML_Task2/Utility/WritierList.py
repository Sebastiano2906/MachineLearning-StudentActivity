...
#laureatiAug = [tuple(row) for row in csv.reader(open('/DSML_Task2/Dataset/DatasetTriennaliAugmented.csv', 'r'))]
Maturità = []
Maturitàtemp = []
MaturitàDict= {}
SchoolDict = {}
...
with open('C:/Users/clara/PycharmProjects/prog2/DSML_Task2/FileGenerated/ListStudent.txt', 'w') as file:
    file.write(json.dumps(Maturità))


with open('C:/Users/clara/PycharmProjects/prog2/DSML_Task2/FileGenerated/DictSchool.txt', 'w') as file:
    file.write(json.dumps(MaturitàDict))

with open('C:/Users/clara/PycharmProjects/prog2/DSML_Task2/FileGenerated/DictCodSchool.txt', 'w') as file:
    file.write(json.dumps(SchoolDict))

df = pd.DataFrame(data={"Tipo_Maturita, Voto_Diploma, CFU_Primo": Total_Write})
df.to_csv("C:/Users/clara/PycharmProjects/prog2/DSML_Task2/FileGenerated/TotalStudent.csv", sep=',', index=False,)