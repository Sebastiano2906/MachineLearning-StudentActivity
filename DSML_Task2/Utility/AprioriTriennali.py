...
import json
import csv
store_data = pd.read_csv('C:/Users/sebas/PycharmProjects/MachineLearning-Local/DSML/Dataset/DatasetStudenti.csv', header=None)
records = [tuple(row) for row in csv.reader(open('C:/Users/sebas/PycharmProjects/MachineLearning-Local/DSML/Dataset/TotalStudent.csv', 'r'))]
print(records[:5])
dataset = []
...
for item in association_rules_dataset:
    with open('C:/Users/sebas/PycharmProjects/MachineLearning-Local/DSML/Utility/OutputApriori.txt', 'w') as file:
