...
#Maturità = json.load(open("C:/Users/clara/PycharmProjects/prog2/DSML_Task2/LinearRegression/ListaStudentiModificata.txt"))
Maturità = [tuple(row) for row in csv.reader(open("C:/Users/clara/PycharmProjects/prog2/DSML_Task2/K-Means/DatasetTriennaliNuovo.csv", 'r'))]
...
minus = 0.0
y_pred_pred = []
School = json.load(open("C:/Users/clara/PycharmProjects/prog2/DSML_Task2/FileGenerated/Tipo_mat.txt"))
