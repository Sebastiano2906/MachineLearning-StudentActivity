...
Laureato = [tuple(row) for row in csv.reader(open("../DatasetTriennaliNuovo.csv", 'r'))] #AGGIUSTARE I PATH, IN MODO DA RAGGIUNGERE QUESTO FILE
tipo_maturità=[]
voto_diploma =[]
cfu_primo =[]
mat_student=[]
...
df_final.to_csv("./ListaStudentClusterStatoStudenti.csv", sep=',', index=False,) #AGGIUSTARE I PATH, IN MODO DA RAGGIUNGERE QUESTO FILE
ClusterFile = [tuple(row) for row in csv.reader(open("./ListaStudentClusterStatoStudenti.csv", 'r'))] #AGGIUSTARE I PATH, IN MODO DA RAGGIUNGERE QUESTO FILE
